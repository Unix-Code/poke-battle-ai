...
from models import Move, Pokemon, Sprite, Type, PokemonStats
...
class PokemonScraper:
    ...
    def _scrape_pokemon(self, poke_url: str) -> Pokemon:
        with open("../poke_specials.json", "r") as f:
            data = json.load(f)
        ...
        full_stats = PokemonStats(**{f.name: self._calc_stat(getattr(base_stats, f.name), 100, is_hp=(f.name == "hp"))
    ...
    def scrape(self, top_level_data: dict) -> list[Pokemon]:
